$(function(){
    ...
    $(".jizhu a").toggle(function(){
            $(".jizhu a").addClass("jizhu_dui");
       },function(){
            $(".jizhu a").removeClass("jizhu_dui");
        }
    );
    $(".reg").click(function(){
        $(".login_show").css("display","none");
        $(".register_show").css("display","block");
    })
    $(".forget").click(function(){
        $(".login_show").css("display","none");
        $(".register_show").css("display","none");
        $(".forget_show").css("display","block");
    })
});